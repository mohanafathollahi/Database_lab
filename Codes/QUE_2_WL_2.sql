...
CREATE UNIQUE INDEX index1 ON departaments(id) PCTFREE 33;
CREATE INDEX index2 ON departaments(nom) PCTFREE 33;
CREATE BITMAP INDEX index3 ON departaments(seu) PCTFREE 0;


ALTER TABLE empleats SHRINK SPACE;
ALTER TABLE empleats MINIMIZE RECORDS_PER_BLOCK; 
CREATE INDEX index4 ON empleats(sou) PCTFREE 33;
CREATE BITMAP INDEX index5 ON empleats(edat) PCTFREE 0;
CREATE BITMAP INDEX index6 ON empleats(dpt) PCTFREE 0;
